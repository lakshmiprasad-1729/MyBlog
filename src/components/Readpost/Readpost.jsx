...
export default function Readpost() {
  ...
  return (
    (postDetails)?(
      ...
      <div className="bg-transparent sm:w-[65dvw] md:w-[50dvw] lg:w-[45dvw] xl:w-[40dvw] 2xl:w-[35dvw]  mt-[7rem] sm:min-h-[80dvh] rounded-xl mx-[2rem] border border-gray-700 pb-[2rem] mb-[4rem]">
